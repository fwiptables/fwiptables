### || || [ ok ] || [ Firewall ] [ Program: fwiptables-cmd ] [ Version: cmd-8.01 ] || ||
### || || [ ok ] || [ Configure ] [ Configure: ./fwiptables-vcmd-v8.01 preferences-modify ] || ||
### || || [ ok ] || [ list-options ] [ List options ] [ list-options md ] || ||
###
    Launch: ./fwiptables-vcmd-v8.01 [ -cli-menu -gui-menu -gui-roll -gui-shell
