...
#####         [Control the iptables rules]
     ...
     continue: Restore the firewall iptables stoped
        reset: Reset the firewall iptables
       fwlist: List the firewall iptables names saved
         save: Save the firewall iptables
      restore: Restore a one firewall iptables
