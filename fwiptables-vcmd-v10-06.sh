...
cmd_homepage_sourceforge="https://sourceforge.net/projects/f-iptables/" ;
cmd_homepage_github="https://github.com/fwiptables/fwiptables" ;
####
####
#### :rutina-final-name:
...
if [ "$first_option" == "gui-roll"  ] ;  then first_option="gui-roll-zenity"   ; exit ; fi
if [ "$first_option" == "gui-shell" ] ;  then first_option="gui-shell-zenity"  ; exit ; fi
####
####
...
echo "$title_md [ $first_option ] [ show the default fwiptables ] "
echo 
cat $default_preferences
echo

echo "$title_md [ info ] [ Change variables with: $cmd_binary preferences-modify ]"
...
####
####
if [ "$first_option" == "preferences-example" ] ; then echo $give_cover
echo
...
echo "allow_use_ipv6=                                     ## void or no"
echo "allow_separate_rules=                               ## void or no"
echo "config_shield_port=22                               ## void or ports"
echo "config_shield_maxtries=10                           ## void or no"
...
echo
echo "$title_md [ info ] ### [ Network Listen ] [ Listen ipv4 ] ###"
...
if [ -f /etc/resolv.conf ]     ; then echo "$title_md [ yes ] [ /etc/resolv.conf ]"     ;
cat /etc/resolv.conf           ; fi
if [ -d /etc/resolvconf ];       then echo "$title_md [ yes ] [ /etc/resolvconf ]";
$command_find /etc/resolvconf  ; fi
if [ -f /etc/resolv.conf.head ]; then echo "$title_md [ yes ] [ /etc/resolv.conf.head ]"; fi
if [ -f /etc/resolv.conf.body ]; then echo "$title_md [ yes ] [ /etc/resolv.conf.body ]"; fi
if [ -f /etc/resolv.conf.tail ]; then echo "$title_md [ yes ] [ /etc/resolv.conf.tail ]"; fi
exit; fi
####
####
#### :rutina-final-ip4:
...
echo
echo "$title_md [ info ] ### [ Network Listen ] [ Listen ipv6 ] ###"
if [ "$command_ss" == "$NULL" ] ; then echo "$tab [ info ] [ install ss command ]"
...
####
####
if [ "$first_option" == "ver" ]; then echo $give_cover
echo "$title_md [ $first_option ] [ Show version about ] [ version.md] "
...
echo "$text_md [ info ] [ loading firewall custom ] [ $directory_config/$second_option ]" ;
...
echo "$text_md [ info ] [ loading firewall off-line ]" ;
launch_rules_firewall="yes" ;
...
echo "$text_md [ info ] [ loading firewall all-permisive ]" ;
launch_rules_firewall="yes" ;
...
echo "$text_md [ info ] [ loading firewall shield-ssh ]" ;
launch_rules_firewall="yes" ;
...
####
####
if [ "$first_option" == "client-basic" ]; then echo $give_cover ; echo $give_load ; 
echo "$text_md [ info ] [ loading firewall client-basic ]" ;
launch_rules_firewall="yes" ; 
...
echo "$text_md [ info ] [ loading firewall client-web ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ;
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
####
####
if [ "$first_option" == "client-git" ]; then echo $give_cover ; echo $give_load ; 
echo "$text_md [ info ] [ loading firewall client-git ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ;
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
####
####
if [ "$first_option" == "client-ipp" ]; then echo $give_cover ; echo $give_load ; 
echo "$text_md [ info ] [ loading firewall client-ipp ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ;
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
####
####
if [ "$first_option" == "client-irc" ]; then echo $give_cover ; echo $give_load ; 
echo "$text_md [ info ] [ loading firewall client-irc ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ;
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall client-vnc ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ;
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall client-torrent ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ; 
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall client-vpn ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ; 
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall client-tor ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ; 
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall client-news ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ; 
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall client-mail ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ; 
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall client-ftp ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ;
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall client-squid ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ; 
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall lan-vpn ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ; 
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall lan-tor ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ; 
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall games-shooter ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ; 
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
####
####
if [ "$first_option" == "games-udp" ]; then echo $give_cover ; echo $give_load ; 
echo "$text_md [ info ] [ loading firewall games-udp ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ; 
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall game-wesnoth ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ; 
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall game-minetest ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ; 
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall game-freeciv ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ; 
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall game-widelands ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ; 
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall server-web ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ; 
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall server-vnc ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ;
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall server-ftp ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ; 
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall server-squid ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ; 
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall server-news ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ; 
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall server-mail ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ; 
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall server-samba ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ; 
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall server-print ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ; 
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall server-ssh ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ;
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall server-lamp ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ; 
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall server-asterisk ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ; 
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall server-mumble ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ; 
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall server-teamspeak ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ; 
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
echo "$text_md [ info ] [ loading firewall server-sql ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ; 
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
####
####
if [ "$first_option" == "server-irc" ]; then echo $give_cover ; echo $give_load ; 
echo "$text_md [ info ] [ loading firewall server-irc ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ;
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
####
####
if [ "$first_option" == "server-domain" ]; then echo $give_cover ; echo $give_load ; 
echo "$text_md [ info ] [ loading firewall server-domain ]" ;
launch_rules_firewall="yes" ; 
type_firewall="predesignated" ; 
name_firewall="$first_option" ;
#### english: max tries for each hour 
...
####
####
if   [ "$first_option" == "ntp" ]; then echo $give_cover
...
####
####
if [ "$first_option" == "list-options" ] ; then echo $give_cover
...
echo "$text_md depends license code examples commands radio variables intro clean-tmp               "
echo "$text_md download install uninstall pc-halt pc-shutdown pc-reboot                             "
...
####
####
if   [ "$first_option" == "clasic-options" ] ; then echo $give_cover 
echo "$title_md $cmd_file [ optional-output ] first_option [ second_option ] "
echo "$title_md"
...
echo "$text_md                        list-options clasic-options info-options filelog autolog ip4 ip6 speed-ip4    "
echo "$text_md                        speed-ip6 speed-glx sockets nodes geoip date free ver version notes depends   "
echo "$text_md                        code commands variables examples intro webcert clean-tmp radio download       "
...
echo "$text_md"
echo "$text_md ls . list filter rules ipv4 "
...
echo "$text_md"
echo "$text_md lsn . list filter rules ipv4 with numbers"
...
echo "$text_md"
echo "$text_md custom . launch a fwiptables firewall file custom"
...
echo "$text_md sockets . show the sockets opened"
...
####
####
if   [ "$first_option" == "info-options" ]; then echo $give_cover
...
####
####
if   [ "$first_option" == "variables" ]; then echo $give_cover
...
####
####
if   [ "$first_option" == "commands" ]; then echo $give_cover
...
####
####
if [ "$first_option" == "listn4-ip" ]; then echo $give_cover 
echo "$title_md [ list4 ] [ List filter ipv4 ] [ it is only sufficent or with legacy or with nft ] "
legacycuatro=$("$command_iptables_legacy" -t filter -L INPUT 1 && \
"$command_iptables_legacy" -t filter -L OUTPUT 1 ) &> /dev/null
nftcuatro=$("$command_iptables_nft" -t filter -L INPUT 1 && \
...
####
####
if [ "$first_option" == "listn6-ip" ]; then  echo $give_cover 
echo "$title_md [ list6 ] [ List filter ipv6 ] [ it is only sufficent or with legacy or with nft ] "
legacyseis=$("$command_ip6tables_legacy" -t filter -L INPUT 1 && \
"$command_ip6tables_legacy" -t filter -L OUTPUT 1 )
nftseis=$("$command_ip6tables_nft" -t filter -L INPUT 1 && \
...
####
####
if [ "$first_option" == "names-control" ]; then  echo $give_cover
...
echo "$title_md [ $first_option ] [ $cmd_binary $cmd_version intro ] [ intro md ] "
echo "$text_md"
...
####
####
if [ "$first_option" == "download" ] ; then echo $give_cover
...
echo "    https://sourceforge.net/projects/f-iptables/files/latest/download"
echo
echo "$title_md [ Link ] Download web link from github.com: "
echo "    https://github.com/fwiptables/fwiptables/releases"
echo 
exit; fi
####
####
...
####
####
if   [ "$first_option" == "nodes" ]; then  echo $give_cover
...
####
####
if   [ "$first_option" == "radio" ] ; then  echo $give_cover
...
####
####
if   [ "$first_option" == "webcert" ] ; then echo $give_cover
...
####
"$NULL")
$command_yad  --info $graphic_window_dimension --text="$cmd_binary good bye";
$command_yad  --progress $graphic_window_dimension --timeout=1 --text="Closing gui menu" --auto-close --auto-kill ; exit ;;
*) fecha_temporal=$(date | $command_sed s/\ //g) ; $cmd_binary $menugtk &> /tmp/fwiptables-$fecha_temporal
...
####
case "$selection_final" in
1)$favorite_graphicall_dialog  --info $graphic_window_dimension --text="$cmd_binary good bye"; exit ;;
...
echo "### #[ fail ] [ First Option: $first_option ] # [ Choose a one valid first option ... ]" ;
...
####
####
echo "$text_md [ _ok_ ] [ Launched: firewall ] [ Type: $type_firewall ] [ Name: $name_firewall ]"
exit; fi
####
####
...
####
$allow_use_ipv4 $allow_use_legacy $command_iptables_legacy  -A  INPUT  \
-s $one_vpn -j ACCEPT -m comment --comment "vpn $one_vpn" &> /dev/null
####
####
$allow_use_ipv4 $allow_use_legacy $command_iptables_legacy  -A  OUTPUT \
-d $one_vpn -j ACCEPT -m comment --comment "vpn $one_vpn" &> /dev/null
####
####
$allow_use_ipv4 $allow_use_nft  $command_iptables_nft     -A  INPUT  \
-s $one_vpn -j ACCEPT -m comment --comment "vpn $one_vpn" &> /dev/null
