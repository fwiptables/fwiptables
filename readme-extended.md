...
###          [ Launch interface ]
              ...
              web OR -web OR -w : Output to text web browser.  | whith bash backend.
            ...
            null OR -null OR -n : Output in null               | without backend.
                    tor OR -tor : Run in torify (tor)          | whith tor backend.
...
---
                 ...
                 cli-menu Or -cli-roll : Graphicall interface with menus   |  whith zenity backend.
...
###          [ List iptables rules numeral]
                 ...
                 listn4 : likes list-filter4.
                 listn6 : likes list-filter6.
                statuns : likes list4 more list6.
---
          listn-filter4 : List iptables filter rules from ipv4.
          listn-filter6 : List iptables filter rules from ipv6.
             listn-nat4 : List iptables nat rules from ipv4.
             listn-nat6 : List iptables nat rules from ipv6.
          listn-mangle4 : List iptables mangle rules from ipv4.
          listn-mangle6 : List iptables mangle rules from ipv6.
             listn-raw4 : List iptables raw rules from ipv4.
             listn-raw6 : List iptables raw rules from ipv4.
        listn-security4 : List iptables security rules from ipv4.
        listn-security6 : List iptables security rules from ipv6
         list-ebtables : List rules ebtables mac of ethernet.
         ist-arptables : List rules arptables arp.
     
###          [ firewall config custom ]
...
---
        ...
        server-teamspeak : Launch a firewall likes server teamspeak.
         ...
         server-asterisk : Launch a firewall likes server asterisk.
           server-domain : Launch a firewall likes server domain.
...
###          [ options state ]
           ...
           ip4                : Show net ip4.
           ip6                : Show net ip6.
           speed-ip4          : Show speed net ip4.
           speed-ip6          : Show speed net ip6.
...
###          [ Tool Install ]
          ...
          upgrade-complete : Upgrade at the latest git version developer.
           upgrade-minimal : Upgrade at the latest git version stable.
...
###          [ Tool computer ]
             ...
             chroot-mount : mount several auxiliar at directory.
            chroot-umount : umount several auxiliar at directory.
                chroot-on : chroot at directory.
                pc-reboot : Reboot computer.
                  pc-halt : Stop computer.
              pc-shutdown : Stop computer.
