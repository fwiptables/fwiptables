...
echo "$title_md [ info ] [ Launch: $cmd_realpath $first_option ip:port ]"
theproxy="/etc/proxy.fwiptables" ; set_on_proxy="$second_option" 
echo "$title_md File generated by fwiptables expert-conf-proxy ip:port"
echo "$title_md Launch proxy ip:port with: source $theproxy"
