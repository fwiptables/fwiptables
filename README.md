...
###  fwiptables install.                                     
    ...
    Put bit of execution. TYPE:   chmod 755 ./fwiptables-version-11-01-bash.sh 
    Install this version. TYPE:   ./fwiptables-version-11-01-bash.sh install   
...
###  [ ver ] [ Show version about ] [ ver.md ]       
   [ info ] [ program ] /root/f-iptables-version/fwiptables-version-11-01-bash.sh With Version cmd-11-01       
   [ info ] [ Details ] fwiptables, FireWall With iptables | fwiptables, One Mini Script in one-file  
   [ info ] [ Binary file     ] /root/f-iptables-version/fwiptables-version-11-01-bash.sh                         
   [ info ] [ Data directory  ] /root/.config/fwiptables-cmd                       
   [ info ] [ Cache directory ] /run/fwiptables                      
   [ info ] [ File format     ] /root/f-iptables-version/fwiptables-version-11-01-bash.sh: Bourne-Again shell script, Unicode text, UTF-8 text executable      
...
/root/f-iptables-version/fwiptables-version-11-01-bash.sh: Bourne-Again shell script, Unicode text, UTF-8 text executable
###  [ options ] [ List general options for fwiptables ] [ list-options.md ]
###  /root/f-iptables-version/fwiptables-version-11-01-bash.sh [optional-output] first_option [second_option]   
###   [ optional-output ]                                                                
