...
###  fwiptables install.                     
    ...
    put bit TYPE: chmod 755 ./fwiptables-version-13-01-bash.sh     
    install TYPE: ./fwiptables-version-13-01-bash.sh install       
...
###  [ version ] [ Show version ] [ version md ]            
   [ info ] [ Somes details in fwiptables-version-13-01-bash.sh ver 13-01 ]  
   [ info ] [ Name program       ] /root/f-iptables-version/fwiptables-version-13-01-bash.sh                 
   [ info ] [ Number Version     ] Mayor 13 Minor 01    
   ...
   /root/.config/fwiptables/fwiptables-preferences/default-preferences-13-01        
   [ info ] [ File  Format       ]      
   /root/f-iptables-version/fwiptables-version-13-01-bash.sh: Bourne-Again shell script, Unicode text, UTF-8 text executable   
...
###  fwiptables-version-13-01-bash.sh [optional-output] first_option [second_option]  
###   optional-output                                                     
...
###   expert (works only without optional output)                         
