...
echo "$text_md radio ip-forward depends license code examples commands variables intro               "
echo "$text_md clean-tmp download install uninstall pc-halt pc-shutdown pc-reboot                   "
...
echo "$text_md                        sockets nodes geoip date free ver version notes depends"
echo "$text_md                        commands variables examples intro webcert clean-tmp radio download"
